...
**Craigslist Scraper** — Craigslist Scraper - Collect public classified listings for local-market research

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/craigslist-scraper?style=social)
...
>
> **Search intent:** collect public Craigslist data for research, enrichment, and monitoring workflows. Related topics: classifieds data, local market data, listing data, python, data extraction.

## What this project is for

`craigslist-scraper` is an implementation-focused Python project for collecting public Craigslist data. It is designed around one practical job: turn a query such as **"restaurants in Seattle"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/craigslist-scraper.git
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "Craigslist", "category": "Marketplace Scrapers"}
  }
}
```
